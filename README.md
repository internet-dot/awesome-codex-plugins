...
- [agenttrace](https://github.com/luoyuctl/agenttrace) - Audit local AI coding-agent sessions for cost, token waste, tool failures, latency, anomalies, health, diffs, and CI gates.
