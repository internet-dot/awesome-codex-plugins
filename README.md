...
- [Praxis](https://github.com/ouonet/praxis) - Token-lean triage-driven workflow skills for coding agents: design, planning, TDD, debugging, review, worktree, subagents, and release. 3–10× cheaper per skill than comparable frameworks while preserving full workflow discipline.
